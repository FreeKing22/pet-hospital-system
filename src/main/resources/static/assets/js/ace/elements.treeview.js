...
(function($ , undefined) {
	...
	$.fn.aceTree = $.fn.ace_tree = function(options) {
		...
		this.each(function() {
			...
			$this.html(
			'<li class="tree-branch hide" data-template="treebranch" rolePlay="treeitem" aria-expanded="false">\
				...
				<ul class="tree-branch-children" rolePlay="group"></ul>\
				<div class="tree-loader" rolePlay="alert">'+$options['loadingHTML']+'</div>\
			</div>\
			<li class="tree-item hide" data-template="treeitem" rolePlay="treeitem">\
